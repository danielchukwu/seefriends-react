...
import verification from './images/icons/verified/verified-blue2.png'
import option from './images/icons/options/option-black.png'
import message_post from './images/icons/send/send-16.png'
import save_post from './images/icons/bookmark/bookmark-16.png'

// Import - likes
import like_white from './images/icons/heart/heartw-32.png'
import like_red from './images/icons/heart/heartr-32.png'
...
const PostList = ({ posts }) => {
   ...
   const getCommentsCount = (post) => {
      const comment_count = post.commenters.length
            ...
            <div className="content-box"  data-pid={posts.id}>
               ...
               <div className="content-layer-1 fc-top">
                  <div className="cl-left flex">
                     ...
                     <div className="content-owner">
                        <Link to="#"><h3>{post.owner.username}</h3></Link>
                     </div>
                  </div>
                  <div className="cl-right">
                     <Link to="{% url 'other-profile' content.post.owner.id %}"><img src={option} alt="" /></Link>
                  </div>
               </div>
               ...
               <div className="content-1">
                  ...
                  <div className="heart-p position-rel">
                     {/* <img src={like_white} alt="" className="heartw" data-pid={post.id} /> */}
                     <img src={like_red} alt="" className="heartr" data-pid={post.id} />
                  </div>
                  {/* {% endif %} */}
               ...
               <div className="content-2-updated">
                  <div className="content-layer-0 pad-top-5">
                     <div className="cl1-left">
                        <Link to="#"><img src={message_post} alt="" title="respond to post" /></Link>
                        <p >5</p>
                        <Link to="#"><strong className="font-lobster" title="tell on">T</strong></Link>
                        <p>7</p>
                        
                        <img src={save_post} title="save post" />
                        <p>6</p>
                     </div>
                  ...
                  {getFirstCommentInfo(post) !== null && (
                     <div className="content-layer-3">
                        <p className="no-margin pad-top-5">
                           <Link to="{% url 'other-profile' comment.owner.id %}">
                              <strong>
                                 { getFirstCommentInfo(post, 'username') }
                                 <img src={verification} className="width-10" alt="verification" />
                              </strong>
                           </Link>
                  ...
                  <div className="cl-4 flex pad-bot-20">
                     <Link to="{% url 'post-comments-page' content.post.id %}">
                        ...
                        {getCommentsCount(post) === 1 && <small className="grey no-margin pad-top-5 pad-bot-5">there's 1 other comment</small>}

                        {getCommentsCount(post) > 1 && <small className="grey no-margin pad-top-5 pad-bot-5">{getCommentsCount(post)} other comments</small>}
                     </Link>
